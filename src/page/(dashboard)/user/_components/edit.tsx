                      ...
                      <div className="card p-4 sm:p-5">
                        ...
                        <div className="mt-4 space-y-4">
                          ...
                          <div className="flex justify-end space-x-2">
                            ...
                            <button className="btn space-x-2 bg-warning font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                              <span>Update</span>
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                className="h-5 w-5"
