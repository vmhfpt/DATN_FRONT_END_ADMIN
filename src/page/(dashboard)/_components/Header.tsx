          ...
          <div className="flex h-full w-full flex-col items-center border-r border-slate-150 bg-white dark:border-navy-700 dark:bg-navy-800">
            <div className="flex pt-4">
              <Link to="index.html">
                <img
                  ...
                  src="https://themesbrand.com/velzon/assets/images/logo-sm.png"
                  alt="logos"
                />
              </Link>
            </div>
            ...
            <div className="flex flex-col items-center space-y-3 py-3">
              ...
              >
                ...
                <div
                  className={show ? "popper-root fixed show active-custom show active-custom" : "popper-root fixed"}
                  x-ref="popperRoot"
